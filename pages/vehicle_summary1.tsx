          ...
          <main className='flex-1'>
            <div className='lg:mt-16 xl:px-24 lg:ml-96'>
              <motion.div
                ...
                className='px-6 pt-4 mx-auto mb-12 max-w-7xl lg:hidden bg-slate-50'
              >
                <div>
              ...
              <div className='max-w-4xl px-6 mx-auto sm:px-20'>
                <h1 className='text-2xl font-Display md:text-4xl md:leading-snug'>
                  Would you like to add more cars or continue to drivers?
                </h1>

                <div className='py-12'>
                  <div className='grid grid-cols-1 gap-4 mb-8 sm:grid-cols-1'>
                    {people.map((person) => (
                      <div
                        key={person.email}
