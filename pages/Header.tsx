...
export default function Header() {
  ...
  return (
    <div className='sticky top-0 z-10'>
      <div className='pt-4 pb-4 pl-4 bg-white border sm:pl-4 sm:pt-4 border-b-slate-200'>
        <button
          type='button'
          className='inline-flex items-center justify-center w-10 h-10 text-gray-500 rounded-md md:h-12 md:w-12 hover:text-gray-900 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-green-500'
